...
import { player, playerColorEnum, playerResultEnum, playerTable } from 'src/db/schema';
...
export class SigninService {
    ...
    registerPlayers(mailAddress : string, gameName : string, pwd: string)
    {
       const currentPlayers : player = {
        ...
        return insertPlayers([currentPlayers], {id: playerTable.playerId, gameName: playerTable.gameName});
    }
}
